 ...
 */
@SystemSetup(extension = HisenseInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		hybrisImportData.setProductCatalogName(HISENSE);
		hybrisImportData.setContentCatalogNames(Arrays.asList(HISENSE));
		hybrisImportData.setStoreNames(Arrays.asList(HISENSE));
