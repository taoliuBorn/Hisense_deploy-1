 ...
 */
package com.hisense.test.setup;
...
import com.hisense.test.constants.HisenseTestConstants;
import com.hisense.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HisenseTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hisensetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hisensetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hisensetest/import/cstickets.impex");
			...
			importImpexFile(context, "/hisensetest/import/csquotes.impex");
		}
	}
}
