...
/**
 * Generated class for type {@link com.hisense.core.jalo.HisenseSizeVariantProduct HisenseSizeVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedHisenseSizeVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>HisenseSizeVariantProduct.size</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>HisenseSizeVariantProduct.size</code> attribute.
	...
	public String getSize(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedHisenseSizeVariantProduct.getSize requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>HisenseSizeVariantProduct.size</code> attribute. 
	...
	public void setSize(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedHisenseSizeVariantProduct.setSize requires a session language", 0 );
		}
