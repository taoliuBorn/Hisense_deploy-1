...
/**
 * Generated class for type {@link com.hisense.core.jalo.HisenseColorVariantProduct HisenseColorVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedHisenseColorVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>HisenseColorVariantProduct.color</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>HisenseColorVariantProduct.color</code> attribute.
	...
	public String getColor(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedHisenseColorVariantProduct.getColor requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>HisenseColorVariantProduct.color</code> attribute. 
	...
	public void setColor(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedHisenseColorVariantProduct.setColor requires a session language", 0 );
		}
