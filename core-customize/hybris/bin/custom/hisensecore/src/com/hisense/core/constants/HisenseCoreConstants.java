 ...
 */
package com.hisense.core.constants;

/**
 * Global class for all HisenseCore constants. You can add global constants for your extension into this class.
 */
public final class HisenseCoreConstants extends GeneratedHisenseCoreConstants
{
	public static final String EXTENSIONNAME = "hisensecore";


	private HisenseCoreConstants()
	{
		//empty
	}
